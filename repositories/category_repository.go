...
func (repo *CategoryRepository) Create(category *models.Category) error {
	...
	err := repo.db.QueryRow(query, category.Nama, category.Harga, category.Stok).Scan(&category.ID)
	return err
}
...
func (repo *CategoryRepository) GetByID(id int) (*models.Category, error) {
	...
	var p models.Category
	err := repo.db.QueryRow(query, id).Scan(&p.ID, &p.Nama, &p.Harga, &p.Stok)
...
func (repo *CategoryRepository) Update(category *models.Category) error {
	...
	result, err := repo.db.Exec(query, category.Nama, category.Harga, category.Stok, category.ID)
	if err != nil {
		return err
	}
